...
from .dual_model import UniversalDualWrapper, DualUNetFormerWrapper
...
def get_model(model_name, in_channels=7, num_classes=2):
    ...
    if model_name == 'deeplabv3p_resnest50':
        ...
        return HF_OneFormer_ConvNeXt(
            ...
            return HF_Mask2Former_ConvNeXt(
                in_channels=in_channels,
                classes=num_classes
            )
        ...
        main_m = smp.Unet("tu-convnext_tiny", encoder_weights="imagenet", in_channels=len(ch1), classes=num_classes)
        aux_m = smp.Unet("tu-convnext_tiny", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        ...
        ch1, ch2 = [0, 1, 2, 3], [4, 5, 6]
        main_m = smp.UPerNet("tu-convnext_small", encoder_weights="imagenet", in_channels=len(ch1), classes=num_classes)
        aux_m = smp.UPerNet("tu-convnext_small", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        return UniversalDualWrapper(main_m, aux_m, ch1, ch2, fusion_type='add')
        ...
        ch1, ch2 = [0, 1, 2, 3], [4, 5, 6]
        main_m = smp.UPerNet("tu-convnext_tiny", encoder_weights="imagenet", in_channels=len(ch1), classes=num_classes)
        aux_m = smp.UPerNet("tu-convnext_tiny", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        return UniversalDualWrapper(main_m, aux_m, ch1, ch2, fusion_type='add')
        ...
        ch1, ch2 = [0, 1, 2, 3], [4, 5, 6]
        main_m = smp.Segformer("tu-convnext_small", encoder_weights="imagenet", in_channels=len(ch1), classes=num_classes)
        aux_m = smp.Segformer("tu-convnext_small", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        return UniversalDualWrapper(main_m, aux_m, ch1, ch2, fusion_type='add')
        ...
        aux_m = smp.Segformer("tu-convnext_base", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        return UniversalDualWrapper(main_m, aux_m, ch1, ch2, fusion_type='add')
    elif model_name == 'dual_segformer_convnextlarge_chv1_add':
        ch1, ch2 = [0, 1, 2, 3], [4, 5, 6]
        main_m = smp.Segformer("tu-convnext_large", encoder_weights="imagenet", in_channels=len(ch1), classes=num_classes)
        aux_m = smp.Segformer("tu-convnext_large", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        return UniversalDualWrapper(main_m, aux_m, ch1, ch2, fusion_type='add')

    elif model_name == 'dual_segformer_convnexttiny_chv1_add':
        ch1, ch2 = [0, 1, 2, 3], [4, 5, 6]
        main_m = smp.Segformer("tu-convnext_tiny", encoder_weights="imagenet", in_channels=len(ch1), classes=num_classes)
        aux_m = smp.Segformer("tu-convnext_tiny", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        return UniversalDualWrapper(main_m, aux_m, ch1, ch2, fusion_type='add')
        ...
        ch1, ch2 = [0, 1, 2, 3], [4, 5, 6]
        main_m = smp.Segformer("tu-convnextv2_tiny", encoder_weights="imagenet", in_channels=len(ch1), classes=num_classes)
        aux_m = smp.Segformer("tu-convnextv2_tiny", encoder_weights="imagenet", in_channels=len(ch2), classes=num_classes)
        return UniversalDualWrapper(main_m, aux_m, ch1, ch2, fusion_type='add')
